            ...
            <div class="flex w-2/5 justify-center items-center bg-white">
                ...
                <div class="mb-1 mt-10">
                    <div class="col-md-7">
                        ...
                        <button class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-gray-400 transition-colors duration-150 bg-none border-2 hover:bg-gray-100 border-gray-400 rounded-lg focus:outline-none">
                            {{ __('Log in with Google') }}
                        </button>

                        <span class="text-xs">Don't have an account yet?
